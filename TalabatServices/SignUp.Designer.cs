namespace TalabatServices
{
    partial class SignUp
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2 = new Label();
            Worker_Checkbox = new CheckBox();
            label3 = new Label();
            Name_Textbox = new TextBox();
            label6 = new Label();
            Phonenumber2_Textbox = new TextBox();
            label7 = new Label();
            Phonenumber_Textbox = new TextBox();
            label8 = new Label();
            Apartment_Textbox = new TextBox();
            label9 = new Label();
            Floor_Textbox = new TextBox();
            label10 = new Label();
            Building_Textbox = new TextBox();
            label11 = new Label();
            District2_StreetName_Textbox = new TextBox();
            label12 = new Label();
            District_Textbox = new TextBox();
            ...
            // 
            Create_Account_Button.BackColor = Color.FromArgb(41, 128, 185);
            ...
            // Service_Combobox
            // 
            Service_Combobox.BackColor = SystemColors.ButtonFace;
            ...
            ClientSize = new Size(1583, 686);
            Controls.Add(Login_Button);
            Controls.Add(label14);
            Controls.Add(label13);
            Controls.Add(Service_Combobox);
            Controls.Add(label12);
            Controls.Add(District_Textbox);
            Controls.Add(label11);
            Controls.Add(District2_StreetName_Textbox);
            Controls.Add(label10);
            Controls.Add(Building_Textbox);
            Controls.Add(label9);
            Controls.Add(Floor_Textbox);
            Controls.Add(label8);
            Controls.Add(Apartment_Textbox);
            Controls.Add(label7);
            Controls.Add(Phonenumber_Textbox);
            Controls.Add(label6);
            Controls.Add(Phonenumber2_Textbox);
            Controls.Add(label3);
        ...
        private CheckBox Worker_Checkbox;
        private Label label3;
        private TextBox Name_Textbox;
        private Label label6;
        private TextBox Phonenumber2_Textbox;
        private Label label7;
        private TextBox Phonenumber_Textbox;
        private Label label8;
        private TextBox Apartment_Textbox;
        private Label label9;
        private TextBox Floor_Textbox;
        private Label label10;
        private TextBox Building_Textbox;
        private Label label11;
        private TextBox District2_StreetName_Textbox;
        private Label label12;
        private TextBox District_Textbox;
